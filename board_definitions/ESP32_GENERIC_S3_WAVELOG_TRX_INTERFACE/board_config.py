...
"""
OLED_DISPLAY_I2C_SCL_PIN_NUMBER = 6  # use None, if you do not wish to have display
OLED_DISPLAY_I2C_SDA_PIN_NUMBER = 7  # use None, if you do not wish to have display
